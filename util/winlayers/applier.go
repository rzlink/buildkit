...
//
// The opts parameter is retained for signature symmetry with the dispatcher in
// Apply(); the per-OS handlers process the layer themselves and don't forward
// any diff.ApplyOpt to a sub-applier.
...
// mount and manage it.
//
// See applyWindowsLayer for why opts is unused.
